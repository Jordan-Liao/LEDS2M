...
def parse_args_and_config():
    ...
    parser.add_argument('-f', '--func_name', type=str, default='rename_samples', help='Path to the config file')
    parser.add_argument('-r', '--root_dir', type=str, default='result/SAMPLE/LEDS2M-f4/sample_to_eval', help='Path to the config file')
    parser.add_argument('-s', '--source_dir', type=str, default='200', help='Path to the source directory')
    parser.add_argument('-t', '--target_dir', type=str, default='temp_folder1', help='Path to the target directory')
