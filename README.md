...
```commandline
python3 main.py --config configs/Template-LEDS2M-f4.yaml --train --sample_at_start --save_top --gpu_ids 0 
```
...
```commandline
python3 main.py --config configs/Template-LEDS2M-f4.yaml --sample_to_eval --gpu_ids 0 --resume_model path/to/model_ckpt
```
